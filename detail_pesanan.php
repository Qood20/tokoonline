...
if(!$pesanan){
    echo "<script>alert('Data pesanan tidak ditemukan');</script>";
    echo "<script>location='index.php?page=pesanan';</script>";
    exit();
}
...
<div class="row">
    ...
    <div class="col-md-6">
        ...
        <strong>Status:</strong> <span class="badge bg-warning"><?php echo $pesanan['status_pesanan']; ?></span><br>
    </div>
</div>
...
<a href="index.php?page=pesanan" class="btn btn-primary">Kembali ke Riwayat Pesanan</a>
